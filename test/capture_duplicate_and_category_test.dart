...
void main() {
  ...
  test(
    'duplicate detection blocks matching notification when SMS is already captured',
    () async {
      final seedState = emptyLedgerState().copyWith(
        ...
        preferences: LedgerPreferences(
          ...
          merchantCategoryRules: {'netflix': 'cat-subs'},
        ),
      );
      ...
      final notificationResult = await controller
          .importNotificationMessageDetailed(
