...
- Web exists under `apps/web` as a companion for reporting, imports, bulk management, and eventual parity.
- Mobile remains the primary product and validation target.
- Do not assume every mobile workflow has a complete web equivalent.
